...
Inspired by the legendary Donut.c, this project gives your terminal a wild spin — literally.
...
Compile the code:
javac Donut.java
💡 Fun Fact This animation went viral as donut.c — only ~200 lines of C code. Now it's reborn in Java so the JVM can enjoy donuts too.

✍️ Author Crafted with ❤️ by Me!! Fueled by coffee ☕ and geometry 📐
